<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="enciclopedia.aspx.cs" Inherits="Vista.enciclopedia" %>
...
<asp:Label runat="server" ID="lblBienvenido"></asp:Label>
  ...
  transition: border-color 0.25s ease, box-shadow 0.25s ease;   " ID="DropDownEnfermedad" runat="server"></asp:DropDownList>
              </div> 
                       <div class="field-wrap">
  ...
  border-radius: 0;
  -webkit-transition: border-color 0.25s ease, box-shadow 0.25s ease;
  transition: border-color 0.25s ease, box-shadow 0.25s ease;   " ID="DropDownSintoma" runat="server"></asp:DropDownList>
              </div> 
