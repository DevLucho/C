        ...
        <div class="form">
            <div class="tab-content">
                <div id="signup" class="YAS">
                    ...
                    <asp:Button ID="btnBuscar" runat="server" Text="Buscar" class="button button-block" OnClick="btnBuscar_Click" />
                    <br />
                    <asp:GridView ID="gdgGrid" runat="server" AutoGenerateColumns="False" OnRowCommand="gdgGrid_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Seleccionar">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgSelec" CommandName="Seleccionar" ImageUrl="~/img/seleccionar.png" Width="22.5px" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
